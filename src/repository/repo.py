...
# The functions sha256sum, _log_or_store, dprint, yaml_serialize, and yaml_load
...
def _init_logger(repo_dir: str) -> logging.Logger:
    """
    ...
    log_dir = os.path.abspath(os.path.join(abs_path, LOG_DIR))
    ...
    repo_dir_basename = os.path.basename(repo_dir).split('_')[0]

    logger = logging.getLogger(repo_dir_basename + '-mmpack-repo')
