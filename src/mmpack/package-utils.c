 ...
 * @name:        package name
 * @version:     package version, assumed "any" is NULL.
 * @repo:        pointer to the repository from which we want to filter. If we
 *               do not want to filter, this field is set to NULL.
 *
 * Return: This function searches a package in the binary index @binindex. In
 *         case of multiple possibilities, the returned package will be the one
 *         with the lastest version matching the requirements
 */
LOCAL_SYMBOL
