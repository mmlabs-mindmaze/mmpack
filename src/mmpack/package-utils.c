                     ...
                     bool unwrap_desc)
{
	...
	case FIELD_SUMSHA:  return digest_from_hexstr(&pkg->sumsha, value);
	case FIELD_SRCSHA:  return digest_from_hexstr(&pkg->srcsha, value);
	case FIELD_DESC:
		if (unwrap_desc)
	...
	case FIELD_SHA:      return digest_from_hexstr(&res->sha256, value);
