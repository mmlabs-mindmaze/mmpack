# @mindmaze_header@
"""
Create mmpack package source tarball

Usage:

mmpack mksource [--git|--src|--path] [--tag <tag>] [path_or_url]

Create mmpack package source specified in argument. If no argument is provided, look
