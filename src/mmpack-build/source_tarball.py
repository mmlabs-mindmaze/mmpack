...
class SourceTarball:
    ...
    def __init__(self, method: str, path_url: str, tag: str = None,
        ...
        try:
            prj_src = self._gen_project_sources(outdir)
    ...
    def _gen_project_sources(self, subdir: str = '') -> ProjectSource:
        ...
        self._process_source_strap(subdir)
        self._store_src_orig_tracing(subdir)
    ...
    def iter_project_sources(self) -> Iterator[ProjectSource]:
        """
