...
If tag is specified, it will be used to use the specified branch/tag in case of
git method. Additionally, for all method, it will indicate the name of sub
folder in the cache to use to build the packages.
...
def parse_options(argv):
    ...
    group.add_argument('--path', dest='method',
                       ...
                       help='interpret argument as path to mmpack packaging')
...
def _is_git_dir(path: str) -> bool:
    ...
    return call(['git', '--git-dir='+path, 'rev-parse', '--git-dir'])
