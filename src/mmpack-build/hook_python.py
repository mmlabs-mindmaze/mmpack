...
_FILENAME_GENERATOR = BuildFilenameGenerator()
...
def _gen_pysymbols(pkgfiles: Set[str],
    ...
    infile = _FILENAME_GENERATOR.get('prov.pyfiles')
...
def _gen_pydepends(pkg: PackageInfo,
                   sitedirs: List[str]) -> Dict[str, Set[str]]:
    infile = _FILENAME_GENERATOR.get('deps.pyfiles')
